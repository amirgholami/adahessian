...
class RobertaModel(FairseqLanguageModel):
    ...
    def __init__(self, args, encoder):
        ...
        self.args = args
        self.args.encoder_normalize_before = False
...
class RobertaLMHead(nn.Module):
    ...
    def __init__(self, embed_dim, output_dim, activation_fn, weight=None, \
        ...
        if encoder_norm_ff not in ['layer', 'group', 'ammlayer']:
            ...
            self.layer_norm = NormSelect(encoder_norm_ff, embed_dim, num_attention_heads)
        if weight is None:
...
class RobertaEncoder(FairseqDecoder):
    ...
    def __init__(self, args, dictionary):
        ...
        self.sentence_encoder = TransformerSentenceEncoder(
            ...
            num_segments=0,
            encoder_normalize_before=False, #args.encoder_normalize_before,
            apply_bert_init=True,
            activation_fn=args.activation_fn,
            encoder_norm_self=args.encoder_norm_self,
            encoder_norm_ff=args.encoder_norm_ff,
        )
...
def xlm_architecture(args):
 ...
 # tall and skinny model for testbed
@register_model_architecture('roberta', 'roberta_benchmark_skinny')
def roberta_benchmark_skinny_architecture(args):
    args.encoder_layers = getattr(args, 'encoder_layers', 12)
...
@register_model_architecture('roberta', 'roberta_benchmark_fat')
def roberta_benchmark_fat_architecture(args):
